...
options:
  ...
  replicas:
    ...
    - If set to None, and service is not present, service replicas will be set to 1.
    - If set to None, and service is present, service replicas will be unchanged.
...
class DockerServiceManager():
    ...
    def update_service(self, name, old_service, new_service):
        task_template, networks, endpoint_spec, mode, labels = new_service.generate_docker_py_service_description(name,
                                                                                                                  self.get_networks_names_ids())
    ...
    def create_service(self, name, service):
        task_template, networks, endpoint_spec, mode, labels = service.generate_docker_py_service_description(name,
                                                                                                              self.get_networks_names_ids())
